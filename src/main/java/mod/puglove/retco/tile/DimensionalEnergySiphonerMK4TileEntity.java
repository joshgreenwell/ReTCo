...
public class DimensionalEnergySiphonerMK4TileEntity extends TileEntity
  ...
  public final int energyGenerated = ReTCoConfig.machines.dimensionalEnergySiphonerMK4Generate.get();

  public final EnergyStorage energy = new EnergyStorage(
      ReTCoConfig.machines.dimensionalEnergySiphonerMK4Capacity.get(),
      ReTCoConfig.machines.dimensionalEnergySiphonerMK4MaxInput.get(),
      ReTCoConfig.machines.dimensionalEnergySiphonerMK4MaxOutput.get());

  private final LazyOptional<EnergyStorage> energyCapabilityExternal = LazyOptional.of(() -> this.energy);
  private int lastEnergy = -1;

  public DimensionalEnergySiphonerMK4TileEntity() {
    super(ReTCoTileEntityTypes.DIMENSIONAL_ENERGY_SIPHONER_MK4.get());
  }
  ...
  public void tick() {
    ...
    final int transferAmountPerTick = ReTCoConfig.machines.dimensionalEnergySiphonerMK4TransferRate.get();
  ...
  public ITextComponent getDisplayName() {
    return new TranslationTextComponent(ReTCoBlocks.DIMENSIONAL_ENERGY_SIPHONER_MK4.get().getTranslationKey());
  }
  ...
  public Container createMenu(final int windowId, final PlayerInventory inventory, final PlayerEntity player) {
    return new DimensionalEnergySiphonerMK4Container(windowId, inventory, this);
  }
