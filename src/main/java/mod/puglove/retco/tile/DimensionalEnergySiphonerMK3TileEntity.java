...
public class DimensionalEnergySiphonerMK3TileEntity extends TileEntity
  ...
  public final int energyGenerated = ReTCoConfig.machines.dimensionalEnergySiphonerMK3Generate.get();
  ...
  public DimensionalEnergySiphonerMK3TileEntity() {
    super(ReTCoTileEntityTypes.DIMENSIONAL_ENERGY_SIPHONER_MK3.get());
  }
  ...
  public ITextComponent getDisplayName() {
    return new TranslationTextComponent(ReTCoBlocks.DIMENSIONAL_ENERGY_SIPHONER_MK3.get().getTranslationKey());
  }
