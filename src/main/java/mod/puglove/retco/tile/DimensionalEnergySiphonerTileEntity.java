...
public class DimensionalEnergySiphonerTileEntity extends TileEntity
  ...
  public final int energyGenerated = ReTCoConfig.machines.dimensionalEnergySiphonerGenerate.get();
  ...
  public DimensionalEnergySiphonerTileEntity() {
    super(ReTCoTileEntityTypes.DIMENSIONAL_ENERGY_SIPHONER.get());
  }
  ...
  public ITextComponent getDisplayName() {
    return new TranslationTextComponent(ReTCoBlocks.DIMENSIONAL_ENERGY_SIPHONER.get().getTranslationKey());
  }
