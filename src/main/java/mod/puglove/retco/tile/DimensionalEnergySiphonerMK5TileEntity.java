...
public class DimensionalEnergySiphonerMK5TileEntity extends TileEntity
  ...
  public final int energyGenerated = ReTCoConfig.machines.dimensionalEnergySiphonerMK5Generate.get();

  public final EnergyStorage energy = new EnergyStorage(
      ReTCoConfig.machines.dimensionalEnergySiphonerMK5Capacity.get(),
      ReTCoConfig.machines.dimensionalEnergySiphonerMK5MaxInput.get(),
      ReTCoConfig.machines.dimensionalEnergySiphonerMK5MaxOutput.get());

  private final LazyOptional<EnergyStorage> energyCapabilityExternal = LazyOptional.of(() -> this.energy);
  private int lastEnergy = -1;

  public DimensionalEnergySiphonerMK5TileEntity() {
    super(ReTCoTileEntityTypes.DIMENSIONAL_ENERGY_SIPHONER_MK5.get());
  }
  ...
  public void tick() {
    ...
    final int transferAmountPerTick = ReTCoConfig.machines.dimensionalEnergySiphonerMK5TransferRate.get();
  ...
  public ITextComponent getDisplayName() {
    return new TranslationTextComponent(ReTCoBlocks.DIMENSIONAL_ENERGY_SIPHONER_MK5.get().getTranslationKey());
  }
  ...
  public Container createMenu(final int windowId, final PlayerInventory inventory, final PlayerEntity player) {
    return new DimensionalEnergySiphonerMK5Container(windowId, inventory, this);
  }
