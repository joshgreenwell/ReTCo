...
public class DimensionalEnergySiphonerContainer extends Container {
  ...
  public DimensionalEnergySiphonerContainer(final int windowId, final PlayerInventory playerInventory,
    ...
    super(ReTCoContainerTypes.DIMENSIONAL_ENERGY_SIPHONER.get(), windowId);
  ...
  public boolean canInteractWith(@Nonnull final PlayerEntity player) {
    return isWithinUsableDistance(canInteractWithCallable, player, ReTCoBlocks.DIMENSIONAL_ENERGY_SIPHONER.get());
  }
