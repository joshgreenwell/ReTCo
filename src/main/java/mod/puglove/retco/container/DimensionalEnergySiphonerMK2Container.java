...
public class DimensionalEnergySiphonerMK2Container extends Container {

  public static Logger logger = LogManager.getLogger(ReTCo.MOD_NAME);

  public final DimensionalEnergySiphonerMK2TileEntity tileEntity;
  ...
  public DimensionalEnergySiphonerMK2Container(final int windowId, final PlayerInventory playerInventory,
    ...
    super(ReTCoContainerTypes.DIMENSIONAL_ENERGY_SIPHONER_MK2.get(), windowId);
  ...
  private static DimensionalEnergySiphonerMK2TileEntity getTileEntity(final PlayerInventory playerInventory, final PacketBuffer data) {
    Objects.requireNonNull(playerInventory, "playerInventory cannot be null!");
    Objects.requireNonNull(data, "data cannot be null!");
    final TileEntity tileAtPos = playerInventory.player.world.getTileEntity(data.readBlockPos());
    if (tileAtPos instanceof DimensionalEnergySiphonerMK2TileEntity) {
      return (DimensionalEnergySiphonerMK2TileEntity) tileAtPos;
    }
  ...
  public boolean canInteractWith(@Nonnull final PlayerEntity player) {
    return isWithinUsableDistance(canInteractWithCallable, player, ReTCoBlocks.DIMENSIONAL_ENERGY_SIPHONER_MK2.get());
  }
