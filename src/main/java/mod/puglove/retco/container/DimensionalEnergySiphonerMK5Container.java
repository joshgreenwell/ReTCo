...
public class DimensionalEnergySiphonerMK5Container extends Container {

  public static Logger logger = LogManager.getLogger(ReTCo.MOD_NAME);

  public final DimensionalEnergySiphonerMK5TileEntity tileEntity;
   ...
   */
  public DimensionalEnergySiphonerMK5Container(final int windowId, final PlayerInventory playerInventory,
   ...
   */
  public DimensionalEnergySiphonerMK5Container(final int windowId, final PlayerInventory playerInventory,
      final DimensionalEnergySiphonerMK5TileEntity tileEntity) {
    super(ReTCoContainerTypes.DIMENSIONAL_ENERGY_SIPHONER_MK5.get(), windowId);
  ...
  private static DimensionalEnergySiphonerMK5TileEntity getTileEntity(final PlayerInventory playerInventory, final PacketBuffer data) {
    Objects.requireNonNull(playerInventory, "playerInventory cannot be null!");
    Objects.requireNonNull(data, "data cannot be null!");
    final TileEntity tileAtPos = playerInventory.player.world.getTileEntity(data.readBlockPos());
    if (tileAtPos instanceof DimensionalEnergySiphonerMK5TileEntity) {
      return (DimensionalEnergySiphonerMK5TileEntity) tileAtPos;
    }
  ...
  public boolean canInteractWith(@Nonnull final PlayerEntity player) {
    return isWithinUsableDistance(canInteractWithCallable, player, ReTCoBlocks.DIMENSIONAL_ENERGY_SIPHONER_MK5.get());
  }
