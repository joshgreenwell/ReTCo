...
public class DimensionalEnergySiphonerMK3Container extends Container {
  ...
  public DimensionalEnergySiphonerMK3Container(final int windowId, final PlayerInventory playerInventory,
    ...
    super(ReTCoContainerTypes.DIMENSIONAL_ENERGY_SIPHONER_MK3.get(), windowId);
  ...
  public boolean canInteractWith(@Nonnull final PlayerEntity player) {
    return isWithinUsableDistance(canInteractWithCallable, player, ReTCoBlocks.DIMENSIONAL_ENERGY_SIPHONER_MK3.get());
  }
