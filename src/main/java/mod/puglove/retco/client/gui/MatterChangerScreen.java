...
public class MatterChangerScreen extends ContainerScreen<MatterChangerContainer> {

  private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(ReTCo.MODID,
      "textures/gui/container/matter_changer.png");

  public MatterChangerScreen(final MatterChangerContainer container, final PlayerInventory inventory,
  ...
  public void render(final int mouseX, final int mouseY, final float partialTicks) {
    ...
    if (arrowHovered && tileEntity.maxSmeltTime > 0) {
      String tooltip = new TranslationTextComponent("gui." + ReTCo.MODID + ".smeltTimeProgress",
          tileEntity.smeltTimeLeft, tileEntity.maxSmeltTime).getFormattedText();
      this.renderTooltip(tooltip, mouseX, mouseY);
    }
  }
