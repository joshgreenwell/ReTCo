...
public class DimensionalEnergySiphonerMK5Screen extends ContainerScreen<DimensionalEnergySiphonerMK5Container> {
  private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(ReTCo.MODID,
      "textures/gui/container/dimensional_energy_siphoner_mk5.png");

  public DimensionalEnergySiphonerMK5Screen(final DimensionalEnergySiphonerMK5Container container,
  ...
  protected void drawGuiContainerBackgroundLayer(MatrixStack stack, final float partialTicks, final int mouseX,
    ...
    final DimensionalEnergySiphonerMK5TileEntity tileEntity = container.tileEntity;
