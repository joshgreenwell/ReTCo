...
public class CompressorScreen extends ContainerScreen<CompressorContainer> {
  ...
  public CompressorScreen(final CompressorContainer container, final PlayerInventory inventory,
  ...
  public void render(final int mouseX, final int mouseY, final float partialTicks) {
    ...
    final CompressorTileEntity tileEntity = this.container.tileEntity;
  ...
  protected void drawGuiContainerBackgroundLayer(final float partialTicks, final int mouseX, final int mouseY) {
    ...
    final CompressorTileEntity tileEntity = container.tileEntity;
